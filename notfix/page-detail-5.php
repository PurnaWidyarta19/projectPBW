...
<head>
    ...
    <title>Kenko BallPoint 3'S | Goprints</title>
...
<body>
    <main>
        <div class="box-img">
            <div class="main-img">
                <img src="image/1-kenko-ballpoint.jpg" alt="" class="gambar-utama">
            </div>
            <div class="sub-img">
                <img src="image/1-kenko-ballpoint.jpg" alt="" class="gambar-1">
                <img src="image/1-kenko-ballpoint.jpg" alt="" class="gambar-2">
                <img src="image/1-kenko-ballpoint.jpg" alt="" class="gambar-3">
            </div>
        </div>
