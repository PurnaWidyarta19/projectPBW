...
<body>
    <main>
        <div class="box-img">
            <div class="main-img">
                <img src="1-Koyuko-Dotliner.jpg" alt="" class="gambar-utama">
            </div>
            <div class="sub-img">
                <img src="1-Koyuko-Dotliner.jpg" alt="" class="gambar-1">
                <img src="1-Koyuko-Dotliner.jpg" alt="" class="gambar-2">
                <img src="1-Koyuko-Dotliner.jpg" alt="" class="gambar-3">
            </div>
        </div>
        ...
        <div class="desc-order">
            <div class="box-text">
                ...
                <div class="deskripsi">
                    ...
                    <p>KOKUYO Dot Liner Hold Glide Adhesive Tape Roller:</p>
                    <p>Smooth and accurate application of glue</p>
                    <p>Great for sealing envelopes, gift wrapping and more</p>
                    <p>Glue is photo-safe and archival-safe</p>
                    <p>Easy to apply</p>
                    <p>> Panjang: 16cm</p>
                    <p>> Lebar: 8.4cm</p>
                    <hr>  
