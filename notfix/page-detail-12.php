...
<body>
    <main>
        <div class="box-img">
            <div class="main-img">
                <img src="image/1-zebra-ballpoint-sarasa-blue.jpg" alt="" class="gambar-utama">
            </div>
            <div class="sub-img">
                <img src="image/1-zebra-ballpoint-sarasa-blue.jpg" alt="" class="gambar-1">
                <img src="image/1-zebra-ballpoint-sarasa-blue.jpg" alt="" class="gambar-2">
                <img src="image/1-zebra-ballpoint-sarasa-blue.jpg" alt="" class="gambar-3">
            </div>
        </div>
        ...
        <div class="desc-order">
            <div class="box-text">
                <div class="header">
                    <h2>Zebra Ballpoint Sarasa 0.5 Blue</h2>
                    <hr>
                </div>
                <div class="price">
                    <del></del>
