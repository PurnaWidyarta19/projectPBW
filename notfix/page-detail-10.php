...
<body>
    <main>
        <div class="box-img">
            <div class="main-img">
                <img src="image/1-faster-ballpoint.jpg" alt="" class="gambar-utama">
            </div>
            <div class="sub-img">
                <img src="image/1-faster-ballpoint.jpg" alt="" class="gambar-1">
                <img src="image/1-faster-ballpoint.jpg" alt="" class="gambar-2">
                <img src="image/1-faster-ballpoint.jpg" alt="" class="gambar-3">
            </div>
        </div>
        ...
        <div class="desc-order">
            <div class="box-text">
                <div class="header">
                    <h2>Faster Ballpoint C-600/F3</h2>
                    <hr>
                </div>
                <div class="price">
                    <del></del>
                ...
                <div class="deskripsi">
                    ...
                    <p>Dirancang Dengan Fokus Pada Penulisan Yang Nyaman, Memberi Anda Pengalaman Menulis Yang 
                       Lancar Namun Tetap Menjaga Kenyamanan.</p>
                    <p>Merk: Faster </p>
                    <p>> Panjang: 15.5cm</p>
                    <p>> Lebar: 3.5cm</p>
                    <p>> tinggi: 3.5cm</p>
