...
<body>
    ...
    <main>
        ...
        <div class="big-box">
            <div class="card-row">
                <div class="box" onclick="window.location.href='page-login.php'">
                    <div class="box-img">
                    ...
                    <div class="box-text">
                        ...
                        <div class="price-ikon">
                            ...
                            <div class="icon">
                                <i class="fa-solid fa-cart-shopping" onclick="window.location.href='page-login.php'"></i>
                            </div>
                        </div>
                    </div>
                </div> 
                <div class="box" onclick="window.location.href='page-login.php'">
                    <div class="box-img">
                        <div class="box-img">
                            <img src="image/1-buku-tulis.jpeg" alt="">
                        </div>
                        <div class="box-text">
