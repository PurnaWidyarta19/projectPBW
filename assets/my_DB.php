<?php    
    ...
    $db_database = "databse_project"; // Write your own db name here
    $db_username = "root"; // Write your own username here
    $db_password = NULL; // Write your own password here
    ...
    $conn = mysqli_connect('localhost', 'root', '', 'databse_project');
?>